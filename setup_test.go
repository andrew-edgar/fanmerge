...
nameserver 10.10.255.253`), 0666); err != nil {
	...
	tests := []struct {
		...
		{`fanmerge . ` + resolv, false, "", []string{"10.10.255.252:53", "10.10.255.253:53"}},
	}
